...
test('renderDashboard() menyambungkan 6 widget live Dashboard Hub (Hero/Summary/Analytics/Favorit/EIE/TanggaKeuangan)', () => {
  ...
  const expected = [
    ...
    'EIEDashboard',
    // S121 (bugfix): TanggaKeuangan ("Tangga Ternak Uang") tadinya cuma
    // ter-render lewat wrap window.showPage + setTimeout(450ms) miliknya
    // sendiri di tangga-keuangan.js -- gagal di boot pertama krn
    // page-dashboard-hub adalah landing page default (showMain() lewat
    // refreshCurrentPage(), bukan showPage()), kartu macet permanen di
    // "Menghitung...". Sekarang disambungkan ke live-wiring yang sama
    // dgn widget lain di atas (lihat modules-render.js).
    'TanggaKeuangan',
  ];
